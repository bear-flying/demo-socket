...
public class SearchServiceImpl implements SearchService {
    ...
    public Map search(Map<String, String> searchMap) {
        ...
        if (searchMap != null){
            ...
            //按照价格进行区间过滤查询   0-500  500-1000  1000-3000 …10000以上
            ...
            //按照品牌进行分组(聚合)查询
            //电视和手机品牌需要分开 所以需要分组查询（聚合查询）给前端返回
            String skuBrand="skuBrand";
            nativeSearchQueryBuilder.addAggregation(AggregationBuilders.terms(skuBrand).field("brandName"));

            //按照规格进行聚合查询
            //规格信息也需要聚合查询 将相对应的数据一并的返回到前端
            ...
            //按照相关字段进行排序查询
            // 1.当前域(综合、销量、新品、评价、价格) 2.当前的排序操作(升序ASC,降序DESC)
            //价格排序示例：localhost:9090/search?pageSearch=1000&sortField=price&sortRule=DESC
            /**
             ...
             * 销量排序：销量排序除了销售数量外，还应该要有时间段限制(如果没有时间限制，早上架的商品销售会有优势)。
             */
